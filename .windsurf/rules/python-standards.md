...
# Windsurf Project Rules - Python MVC & Clean Architecture

Tài liệu này định nghĩa các quy chuẩn bắt buộc để Cascade (Windsurf AI) tuân thủ trong suốt quá trình phát triển dự án này.
...
1. **Phân tích:** Trước khi code, Cascade phải giải thích phương án thiết kế dựa trên Clean Architecture.
